function startFarewell() {
    ...
    // Ganti pesan
    message.textContent = "INTERUPSIIII";
    subMessage.textContent = "Kadang kita terlalu sibuk ngejar dunia, sampai lupa siapa yang kasih napas, kasih waktu, kasih hidup. Kita sering curhat ke orang yang bahkan nggak bisa bantu apa-apa, tapi lupa bahwa Allah selalu siap denger, bahkan sebelum kita ngomong.";
